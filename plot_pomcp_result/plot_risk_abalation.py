...
parse_file("/home/gbyu/pomcp_exp/log/risk/risk_log_beta_-0.05_without_past.txt")
rs1_wopast_good_rocks_mean, rs1_wopast_good_rocks_std = parse_rocks("/home/gbyu/pomcp_exp/plot_pomcp_result/data/good.txt")
rs1_wopast_bad_rocks_mean, rs1_wopast_bad_rocks_std = parse_rocks("/home/gbyu/pomcp_exp/plot_pomcp_result/data/bad.txt")
rs1_wopast_undiscounted_return_mean, rs1_wopast_undiscounted_return_std = parse_returns("/home/gbyu/pomcp_exp/plot_pomcp_result/data/undiscounted_return.txt")
rs1_wopast_check_action_mean, rs1_wopast_check_action_std = parse_rocks("/home/gbyu/pomcp_exp/plot_pomcp_result/data/check_action.txt")
print("-- Data Extraction Finished! --")
...
ax1.errorbar(num_simulations[:len(rs1_wopast_good_rocks_mean)], rs1_wopast_good_rocks_mean, yerr=rs1_wopast_good_rocks_std, marker='^', capsize=3, label=r"RS-POMCP w/o past, $\beta = -0.05$")
...
ax2.errorbar(num_simulations[:len(rs1_wopast_bad_rocks_mean)], rs1_wopast_bad_rocks_mean, yerr=rs1_wopast_bad_rocks_std, marker='^', capsize=3, label=r"RS-POMCP w/o past, $\beta = -0.05$")
...
ax3.errorbar(num_simulations[:len(rs1_wopast_check_action_mean)], rs1_wopast_check_action_mean, yerr=rs1_wopast_check_action_std, marker='^', capsize=3, label=r"RS-POMCP w/o past, $\beta = -0.05$")
...
ax4.errorbar(num_simulations[:len(rs1_wopast_undiscounted_return_mean)], rs1_wopast_undiscounted_return_mean, yerr=rs1_wopast_undiscounted_return_std, marker='^', capsize=3, label=r"RS-POMCP w/o past, $\beta = -0.05$")
...
plt.tight_layout()
plt.savefig("/home/gbyu/pomcp_exp/plot_pomcp_result/figs/rocksample_risk_wo_past.png")
